package com.example.nogizaka46top.a10456010;
...
public class UpdateActivity extends AppCompatActivity {
    private TextView txtNoU, txtnameU, txtTelU, addressUp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addressUp = findViewById(R.id.addressUp);
        ...
        cursor = db.rawQuery("select * from person where _id="+ _id, null);
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cv.put("address", addressUp.getText().toString());
                cv.put("gender", btn.getText().toString());
                cv.put("age", sprAgeU.getSelectedItem().toString());
                cv.put("tel", txtTelU.getText().toString());
                if(btn.getText().toString().equals("男")){
                    cv.put("imgid", R.drawable.mann);
                }else if(btn.getText().toString().equals("女")){
                    cv.put("imgid", R.drawable.madchen);
                }
                Log.d("myIc", "onClick: " + _id);
        ...
        btnPre.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nextC.moveToNext()) {
                    ...
                    addressUp.setText(nextC.getString(nextC.getColumnIndex("address")));
                    ...
                    _id = Long.parseLong(nextC.getString(nextC.getColumnIndex("_id")));
                }
                Toast.makeText(UpdateActivity.this, "hello", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void loadData() {
        ...
        addressUp.setText(cursor.getString(cursor.getColumnIndex("address")));
